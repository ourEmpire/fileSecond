            ...
            case 'A':
                ...
                if(login.equals("登录成功")){
                    ...
                    switch (option){
                        case 'a':
                        case 'A':
                            System.out.println(username+"先生/女生，您的金额为："+bs.balance(username));
                            break;
                        case 'b':
                        case 'B':
                            System.out.print("请输入存款金额：");
                            money = input.nextFloat();
                            if(bs.deposit(username,money)){
                                System.out.println("\n存款成功");
                        ...
                        case 'C':
                            ...
                            money = input.nextFloat();
                            if(bs.withdrawal(username,money)){
                                System.out.println("\n存款成功");
                        ...
                        case 'D':
                            ...
                            System.out.print("\n请输入转账金额：");
                            money = input.nextFloat();
                            System.out.println("\n"+bs.transfer(username,money,toUser));
                            break;
                        case 'e':
                        case 'E':
